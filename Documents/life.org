...
* Résumé
  ...
  *Euber Alexandre De Sousa Barbosa*
  ...
  @easbarbosa: git.sr.ht, github, gitlab, twitter
  ...
  *SKILLS*
  -----
    - Desenvolvimento de Aplicações CLI em Ruby e Common Lisp.
    ...
    - Controle de Versão com Git: Rebase, Squash, Merge.
    - Criacao e Gerencia de imagens containers.
