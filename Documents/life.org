...
* Résumé
  ...
  *Euber Alexandre De Sousa Barbosa*
  ...
  @elxbarbosa: Github, Gitlab, Twitter
  ...
  *OBJETIVO*
  -----
    ...
    gerenciadores de empacotamento, compilacao de software C com uso do make, cmake, ninja,
  ...
  *SKILLS*
  -----
    - Desenvolvimento de Aplicações CLI em Golang, Ruby, .NET e Common Lisp.
    - Ferramentas e Configurações em Sistemas UNIX em especial Debian, FreeBSD.
    - Experiência em Shell Script em GNU Bash, Fish Shell e POSIX.
    - Controle de Versão com Git: Squash, Merge.
    - AWS Cloud:
    - Criacao e Gerencia de imagens Docker.
    - Básico em Front-End: HTML,CSS.
    - Uso de editores CLI como GNU Emacs, NeoVIM, Nano.
    - Soft Skills sendo Secretário de Advocacia e Radio Taxi.
