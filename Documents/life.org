...
* Résumé
  ...
  *Euber Alexandre De Sousa Barbosa*
  ...
  @easbarbosa: git.sr.ht, github, gitlab, telegram
  ...
  *OBJETIVO*
  -----
    ...
    Windows Managers e automação de tarefas com Shell Scripts.
  ...
  *SKILLS*
  -----
    - Desenvolvimento de Aplicações CLI em Ruby e .
    - Ferramentas e Configurações do Debian, CentOS.
    ...
    - Uso de editores GNU Emacs, NeoVIM, Nano, VSCode.
