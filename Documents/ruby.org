...
- [[#rails][Rails]]
  - [[#cli][Cli]]
    - [[#database][Database]]
    - [[#models][Models]]
    - [[#console-railsconsole][Console (rails.console)]]
    - [[#env][ENV]]
  - [[#traits][Traits]]
  - [[#models][Models]]
- [[#concepts][Concepts]]
...
*** Console (rails.console)
    ...
    | save   | a.save                                                        | save object to db         |
    | new    | a.new                                                         | create an empty object    |
    | count  | A.count                                                       |                           |
    | find   | A.find(3) / A.find([4,5])                                     |                           |
    | first  | A.first   / A.first.title                                     |                           |
    | last   | A.last                                                        |                           |
    | all    | A.all / A.all.size / A.all.each { \a\ puts a.title }          | relational / as array     |
    | order  | A.order(:order)                                               | order per title           |
