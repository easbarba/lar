...
** Books
   ...
   |----------------------------------+-----------------------------------+---------------------------------------------+-----------------------------------------------+----------|
   | Pragmatic Ruby (Pickaxe)         | 22. The Ruby language             | Proc Objects                                | Fibers, Threads, and Processes/Multithreading |          |
   | Practical Object-Oriented Design | Reducing Costs with Duck Typing   |                                             |                                               |          |
   | Effective Testing - RSpec3       | The RSpec Way                     |                                             |                                               |          |
...
** SLOC
   | Project    | folder | file          | @                     |
   |------------+--------+---------------+-----------------------|
   | rake       | rake   | file_list.rb  | display_cause_details |
   | rspec-core | core   | configuration | deprecation_stream=   |
   | rubocop    |        |               |                       |
