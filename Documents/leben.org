...
* Résumé
  ...
  *Euber Alexandre De Sousa Barbosa*
  ...
  Brasília, DF -  (61) 98110 - 3178

  elxbarbosa@gmail.com

  @elxbarbosa: Gitlab, Github, Twitter


  *OBJETIVO*
  -----
    Usuário de Distribuições Linux por mais de 10 anos qual experimentei
    suas versões de servidores e suas ferramentas internas como compilamento de Kernel,
    gerenciadores de empacotamento, compilacao de software C e C++ com uso do make, cmake, ninja,
    como também uso extenso de aplicacoes CLI como Grep, Find, Gerenciamento de Processos, ssh,
    Windows Managers e automação de tasks com scripts.
  ...
  *SKILLS*
  -----
    ...
    - Desenvolvimento de Aplicações CLI para automação de tasks em Ruby, .NET e Common Lisp.
    - Conhecimento de Servidores, Configurações e Ferramentas internas no Debian, FreeBSD, Gentoo e GuixSD.
    - Experiência em Scripting em GNU Bash, Fish Shell e POSIX.
    - Controle de Versão com Git e varias commits aceito em repositorios do Github.
    - Soft Skills sendo Secretário de advocacia por anos.
    - Conhecimento básico em Front-End (HTML,CSS).
    - Editores CLI como emacs, neovim, zile, nano.
