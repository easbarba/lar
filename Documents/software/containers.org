...
| books                     | chapter                                       | at                                              |
|---------------------------+-----------------------------------------------+-------------------------------------------------|
| Learn Docker Fundamentals | 4 Creating and Managing Container Images      | What are images?                                |
| Docker for Developers     | Sharing Containers Using Docker Hub           | Implementing a sample microservices application |
| Docker 4 Rails developers | CHAPTER 8 Testing in a Dockerized Environment |                                                 |
