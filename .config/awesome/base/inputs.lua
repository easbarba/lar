...
globalkeys = gears.table.join(
   ...
   awful.key({ modkey, "Shift" }, "w",     function() awful.spawn("gota volume up")                 end),
   awful.key({ modkey, "Shift" }, "s",     function() awful.spawn("gota volume down")               end),
   awful.key({ modkey, "Shift" }, "e",     function() awful.spawn("gota volume toggle")             end),
   awful.key({ modkey, "Shift" }, "a",     function() awful.spawn("gota bright up")                 end),
   awful.key({ modkey, "Shift" }, "d",     function() awful.spawn("gota bright down")               end),
   ...
   awful.key({ modkey,         }, "o",     function() awful.spawn("gota screen full")               end),
   awful.key({ modkey, "Shift" }, "o",     function() awful.spawn("gota screen partial")            end),
